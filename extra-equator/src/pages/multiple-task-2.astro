...
<html lang="nl">
  ...
  <section class="exercises">
    <article class="card">
      <img class="card-image" src="/icon/rouwtaak-2-foto.png" alt="" />
  ...
  <style>
    ...
    *::-webkit-scrollbar {
    ...
    main {
      ...
      background-image: url(/icon/rouwtaak-2-grad.png),
        url(/icon/rouwtaak-2-grad.png), url(/icon/rouwtaak-2.png);
      background-position:
